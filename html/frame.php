...
//if (preg_match("/10.0.0.1/",$visitor)) {
...
//Application Title
define('APP_TITLE', 'Digital Frame Manager');
...
$auth_users = array(
	'frame' => '$2y$10$4URqGV2PuVN3ccbp15KOb.5TazyyNZ6gr9js.uZKhYAv5BilrJk4m' //frame
);
...
$allowed_upload_extensions = 'gif,png,jpg';
            ...
            <div class="container h-100">
                <div class="row justify-content-md-center h-100">
					...
					<br>
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn-block mt-4" role="button">
                                            <?php echo lng('Login'); ?>
                                        </button>
                                    </div>
                                </form>
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; <a href="https://www.skwarebocks.com" target="_blank" class="text-muted">skwarebocks.com</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
		...
		<li class="list-inline-item"><input type="submit" class="hidden" name="copy" id="a-copy" value="Copy">
                    <a href="/refresh.php" class="btn btn-small btn-outline-primary btn-2"><i class="fa fa-files-o"></i> <?php echo lng('Refresh Digital Frame') ?> </a></li>
		</ul>
        </div> 
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Digital Frame File Manager';      $tr['en']['AppTitle']           = 'Digital Frame File Manager';
